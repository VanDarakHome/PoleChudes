while True:
    ...
    if first_question == '1':
        ...
        if second_question == '1':
            while True:
                ...
                print("Пример: *а*а")
                print("Как видите, вы угадали букву. У вас будет список букв, которые вы использовали.")
                print("\n1) Далее")
                rule2 = input()
                while rule2 != '1':
                    print("Даю вам ещё время, чтобы понять правило игры.")
            ...
            while True:
                ...
                print("Example: foot")
                print("Good job. We won that game, but be carefull you may not guess the letter")
    ...
    if important_choose == '1':
        print("Всё прекрасно! Теперь ваша игра будет на Русском. Ваши слова тоже будут на Русском,")
    ...
    if language == '1':  # Русский язык
        ...
        if BIG_CHOICE == '1':
            WORDS = {"яма", "нос", "рот", "глаз", "волк", "рыба", "лужа", "краб",
                     ...
                     "батон", "земля", "масло", "волна", "птица", "пятно",
                     "ведро", "дождь", "шапка", "поиск", "башня", "щипцы", "закат",
                     "пауза", "песня", "сдача", "полка", "билет", "халва",
                     "кочка", "петля", "осень", "ладонь", "король", "опушка", "куртка",
                     "сказка", "звезда", "пряник", "дружба", "секрет",
                     "музыка", "свинья", "камень", "молния", "дерево", "стекло", "минута",
                     "правда", "сердце", "балкон", "стакан", "колесо",
                     "железо", "картон", "грибок", "корова", "остров", "машина", "голова",
                     "радуга", "прятки", "сторож", "защита", "павлин",
                     "рассол", "журнал", "творог", "осадок", "хлопья", "микроб", "письмо",
                     "льдина", "пример", "джокер", "крючок", "пылесос",
                     "полдник", "зеркало", "табурет", "красота", "переход", "желание",
                     "конфета", "учитель", "корабль", "трещина",
                     "мультик", "магазин", "дедушка", "свисток",
                     "игрушка", "доброта", "подушка",
                     "водопад", "загадка", "зарядка", "копейка",
                     "леопард", "ошейник", "водолаз", "батарея",
                     "решётка", "полиция", "стрелка",
                     "бутылка", "записка", "сенокос", "новости", "серебро",
                     "корзина", "овчарка", "айсберг", "пластик", "вторник", "интерес",
                     "лисёнок", "лягушка", "котлета", "накидка",
                     "доспехи", "аквапарк", "снежинка", "пирамида", "кладовка", "картошка",
                     "раковина", "разговор", "прогулка", "сосулька", "картинка",
                     "прихожая", "скатерть", "мармелад", "карамель", "квартира",
                     "непогода", "карточка", "лестница", "переулок",
                     "заставка", "микрофон", "прохожий", "скарабей", "телескоп", "угощение",
                     "пришелец", "доставка", "баклажан", "дикобраз",
                     "барбарис", "работник", "кристалл", "черепаха", "телевизор", "покрывало",
                     "невидимка", "занавеска", "строитель", "бульдозер", "пластилин",
                     "указатель", "градусник", "наволочка", "квитанция",
                     "футболист", "велосипед", "подоконник",
                     "аттракцион", "экскаватор", "троллейбус", "дрессировка", "дельфинарий",
                     "перекрёсток", "тираннозавр", "сигнализация",
                     'администрация', 'электронейтральный', 'оториноларинголог',
                     'программирование', 'гидроэлектростанция',
                     'достопримечательность', 'рентгеноэлектрокардиографический',
